...
export { serveStorageFile, generateThumbnailOnDemand, syncThumbnailsToStatic, syncStorageToDist, createMediaRouteHandler, DEFAULT_MIME_TYPES, DEFAULT_CACHE_CONTROL, DEFAULT_THUMBNAIL_FORMATS } from "./payload/file-server.js";
